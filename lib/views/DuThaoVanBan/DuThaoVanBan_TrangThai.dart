...
class MyDuThaoTrangThai extends StatefulWidget {
  final id;
  MyDuThaoTrangThai({this.id});
  @override
  _MyDuThaoTrangThai createState() => new _MyDuThaoTrangThai();
}

class _MyDuThaoTrangThai extends State<MyDuThaoTrangThai> {
  @override
  void dispose() {
    print('Đóng form trạng thái vb dt');
    super.dispose();
  }
  ...
  void _click_add() {
    if (selectedValue != null) {
      ...
      objEvent.data = data;
      BlocProvider.of<BlocDuThaoVanBanAction>(context).add(objEvent);
    } else
