...
class DatXeGuiNhanpanel extends StatelessWidget {
  List<ThongTinDatXeGuiNhanItem> lstobjguinhan;
  DatXeGuiNhanpanel({@required this.lstobjguinhan});
  ...
  Widget _buildView({List<ThongTinDatXeGuiNhanItem> topStories}) {
