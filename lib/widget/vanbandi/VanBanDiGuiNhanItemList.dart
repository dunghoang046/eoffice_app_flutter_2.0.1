...
class VanBanDiGuiNhanItemList extends StatelessWidget {
  final List<VanBanDiGuiNhanItem> lstobj;
  VanBanDiGuiNhanItemList({@required this.lstobj});
  ...
  Widget build(BuildContext context) {
    ...
    Widget content(VanBanDiGuiNhanItem obj, int index) => Container(
